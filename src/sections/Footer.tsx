...
export function Footer() {
  return (
    <footer className="relative z-10 border-t hairline mt-4">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
        <div className="max-w-md">
          <a href="#top" className="flex items-center gap-2.5">
            <img src="/logo.jpg" alt="Lookism solutions" className="w-7 h-7 rounded object-cover border hairline" />
            <span className="font-semibold text-ink">Lookism solutions</span>
          </a>
      ...
      <div className="border-t hairline py-5 text-center eyebrow">© 2026 Lookism solutions</div>
    </footer>
  );
}
